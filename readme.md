<div align="center">
    ...
    <h1 align="center">Teste Frontend - James Oliveira da Silva</h1>
</div>

## O Candidato

**Nome:** `James Oliveira da Silva`

**E-mail:** `jamesodas@gmail.com`

**Usuário:** @jamesdasilva
...
- Criar uma lista de produtos, consumindo os dados da [API de produtos](https://us-central1-boitata-233919.cloudfunctions.net/api/products);
...
- Valor do frete é obtido via [API de frete](https://us-central1-boitata-233919.cloudfunctions.net/api/freight/<valor-do-cep>)

O layout da página deve estar de acordo com os wireframes e o protótipo feito no Marvel.

## API

[API de frete](https://us-central1-boitata-233919.cloudfunctions.net/api/freight/) é um `GET`. É obrigatório passar `CEP` como parametro, ex:

```
https://us-central1-boitata-233919.cloudfunctions.net/api/freight/<valor-do-cep>
```
...
[API de produtos](https://us-central1-boitata-233919.cloudfunctions.net/api/products) é um `GET`. Abaixo é a representação de um produto.
